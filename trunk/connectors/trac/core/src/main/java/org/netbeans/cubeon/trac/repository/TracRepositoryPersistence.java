...
class TracRepositoryPersistence {
    ...
    private TracTaskRepositoryProvider provider;
    private FileObject baseDir;

    TracRepositoryPersistence(TracTaskRepositoryProvider provider, FileObject baseDir) {
        this.provider = provider;
        this.baseDir = baseDir;
    }

    void addRepository(TracTaskRepository repository) {
    ...
    void removeRepository(TracTaskRepository repository) {
        Element repositoryElement = null;
