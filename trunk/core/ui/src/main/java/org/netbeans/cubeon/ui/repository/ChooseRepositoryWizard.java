...
class ChooseRepositoryWizard implements WizardDescriptor.Panel<WizardObject> {
     ...
     */
    private ChooseRepositoryProvider component;
    ...
    public Component getComponent() {
        if (component == null) {
            component = new ChooseRepositoryProvider(this);
        }
        return component;
    }
    ...
    public boolean isValid() {
        ...
        return component.isTypeSelected();
    ...
    public void storeSettings(WizardObject settings) {
        settings.setType(component.getTaskRepositoryType());
    }
}
