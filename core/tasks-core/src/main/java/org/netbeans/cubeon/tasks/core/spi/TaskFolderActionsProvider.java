...
public interface TaskFolderActionsProvider {
     ...
     * New Menu Actions
     * @param taskFolder
     * @return Actions that show in  task folder node. Can return null elements 
     * to add sepetator to menu 
     */
    Action[] getNewActions(TaskFolder taskFolder);
     ...
     */
    Action[] getActions(TaskFolder taskFolder);
}
