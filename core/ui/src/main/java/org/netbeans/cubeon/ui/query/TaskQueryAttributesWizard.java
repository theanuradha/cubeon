...
class TaskQueryAttributesWizard implements WizardDescriptor.Panel<WizardObject> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private TaskQueryAttributes component;
    private final TaskRepository defaultRepository;

    public TaskQueryAttributesWizard() {
        defaultRepository = null;
    }

    public TaskQueryAttributesWizard(TaskRepository defaultRepository) {
    ...
    public void storeSettings(WizardObject settings) {
        ConfigurationHandler handler = component.getHandler();
        assert handler != null;
        settings.setQuery(handler.getTaskQuery());
    }
}
