 ...
 * @author Anuradha
 */
public class GCodeExceptionHandler {
    private static final Logger LOGGER=Logger.getLogger(GCodeExceptionHandler.class.getName());
    private GCodeExceptionHandler() {
    }

    public static void notify(GCodeException je) {
