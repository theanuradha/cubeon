 ...
 * @author Anuradha
 */
public class JiraOfflineTaskSupport implements OfflineTaskSupport {

    private final JiraTaskRepository repository;

    public JiraOfflineTaskSupport(JiraTaskRepository repository) {
    ...
    public boolean hasOutgoingChanges(TaskElement element) {
        ...
        return jiraTask.isModifiedFlag() || jiraTask.isLocal();
    }
}